...
public interface AuditRepository extends CrudRepository<Audit, Integer> {
    ...
    @Query(value = "select a.id, e.nombre as empresa, mr.nombre as \"marcoRegulatorio\", cc.\"name\" as estado from g5_ssmr.auditoria a \n" +
            ...
            "inner join g5_ssmr.catalogue_child cc on a.id_estado = cc.id_catalogue_child", nativeQuery = true)
    List<AuditDetailProjection> getAll();
